    ...
    <div class="signup">
        ...
        <form class="signup__form" action="signup.php" method="post">
            <div class="form-group">
                ...
                <input class="form-control worker-form__worker-input" type="text" value="<?php echo $_POST["email"]; ?>" name="email" id="email">
            </div>
            <div class="form-group">
                <label for="login">Логин:</label>
                <input class="form-control worker-form__worker-input" type="text" value="<?php echo $_POST["login"]; ?>" name="login" id="login">
            </div>
            <div class="form-group">
                <label for="pass">Пароль:</label>
                <input class="form-control worker-form__worker-input" type="password" value="<?php echo $_POST["pass"]; ?>" name="pass" id="pass">
            </div>
            <div class="form-group">
                <label for="pass_confirm">Повторите пароль:</label>
                <input class="form-control worker-form__worker-input" type="password" value="<?php echo $_POST["pass_confirm"]; ?>" name="pass_confirm" id="pass_confirm">
            </div>
